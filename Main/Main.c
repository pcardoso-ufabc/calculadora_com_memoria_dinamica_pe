...
int main() {
    ...
    char *num_1 = ler_string(&MAX, &tamanho);
    
    printf("Digite o segundo numero inteiro: ");
    char *num_2 = ler_string(&MAX, &tamanho);
    ...
    while (ope != 7) {
        ...
        if (ope == 1){
            ...
            if(negA == negB){
                digitos = soma(A, tamA, B, tamB, S, MAX);
                negativo = negA;
            } else {
                digitos = subtracao(A, tamA, B, tamB, S, &negativo, MAX);
            ...
            digitos = divisao(A, tamA, B, tamB, Q, R, &tamR, MAX);
